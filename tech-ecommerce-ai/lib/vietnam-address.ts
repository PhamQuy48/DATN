...
// Simplified district data - in real app, you would load this dynamically based on province
export const getDistrictsByProvince = (provinceCode: string) => {
  // This is a simplified version. In production, use a complete address API
